...
function fetchAirstackApiStats(apiUrl: string, target: string, requester: string): any {
    ...
    let snapshotSubgraphUrl = "https://gateway.thegraph.com/api/{}/subgraphs/id/3Q4vnuSqemXnSNHoiLD7wdBbGCXszUYnUbTz191kDMNn";
